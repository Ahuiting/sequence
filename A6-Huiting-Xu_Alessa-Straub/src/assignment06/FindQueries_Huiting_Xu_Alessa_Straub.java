 ...
 */
public class FindQueries_Huiting_Xu_Alessa_Straub {
	public static void main (String[] args) throws IOException {
		System.out.println(FindQueries_Huiting_Xu_Alessa_Straub.class.getSimpleName());
		...
		var queryItems=FastA_Huiting_Xu_Alessa_Straub.read(args[1]);
